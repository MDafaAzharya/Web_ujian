...
<body>
    ...
    <form action="prosessign.php" method="post"> 
        ...
        <table class="tabellogin">
            ...
            <tr>
                <td> <input type="text" placeholder="Create Username" required class="input" name="user"></td>
            </tr>
            <tr>
                <td> <input type="text" placeholder="Username" required class="input"></td>
            </tr>
            <tr>
                <td> <input type="password" placeholder="Create Password" required class="input" name="pass"></td>
            </tr>
            <tr>
                <td> <input type="password" placeholder="Confirm Password" required class="input"></td>
            </tr>
            <tr>
                <td> <input type="text" placeholder="role" class="input" name="role"></td>
            </tr>
            <tr>
                <td> <input type="submit" value="Login" class="submit"></td>
            </tr>
            <tr>
                <td> <p class="p4"> Sudah Punya akun? <a href="login.php"> Login Disini</a></p></td>
            </tr>
        </table>
        </div>
    </form>
