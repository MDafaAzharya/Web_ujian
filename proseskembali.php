...
if ($benda = 0) {
    ...
    $insert =mysqli_query($koneksi, "INSERT INTO `kembali`(`id_siswa`, `nama_siswa`, `kelas`, `nama_alat`, `kode_brg`, `jumlah_brg`, `tglpinjam`, `tglkem`) VALUES ('$kode','$name','$class','$brg','$idbrg','$jumlah','$pjm','$kem')");
       if($insert){
           //update stok
