<?php
include 'koneksi.php';
$sql = "SELECT * FROM kembali,stok WHERE kembali.nama_alat = stok.id_brg ORDER BY kode_brg";
...
<form action="" method="get">
       <table>
            ...
            <td> <?php echo $rows['tglpinjam']; ?></td>
            <td> <?php echo $rows['tglkem']; ?></td>
            <td> <a href="edit3.php?kode=<?php echo $rows['id_siswa']?>"><box-icon name='edit'> </box-icon></a></td>
            <td> <a href="delete3.php?id_siswa=<?php echo $rows['id_siswa']; ?>" class="delete" id="delete"> <box-icon name='folder-minus'></box-icon></a></td>
        </tr>
        <?php endforeach ?> 
